...
heat dir ../templates -cg templatesFiles -var var.SourceDir -scom -sreg -sfrag -srd -gg -dr templatesdir -o templates.wxs
...
candle -dSourceDir=../templates templates.wxs
candle -dSourceDir=../lib lib.wxs
candle -dSourceDir=../sports sports.wxs
light -ext WixUIExtension -ext WixUtilExtension -cultures:en-us -loc lang/Loc_en-us.wxl -out EasyTournament-@VERSION@.msi wixinstaller_rel.wixobj LicenseAgreementDialogOverwritten.wixobj helpDe.wixobj helpEn.wixobj res.wixobj templates.wixobj lib.wixobj sports.wixobj
candle -ext WixUIExtension -ext WixUtilExtension -dLANG=1031 wixinstaller_rel.wxs 
light -ext WixUIExtension -ext WixUtilExtension -cultures:de-de -loc lang/Loc_de-de.wxl -out EasyTournament-de.msi wixinstaller_rel.wixobj LicenseAgreementDialogOverwritten.wixobj helpDe.wixobj helpEn.wixobj res.wixobj templates.wixobj lib.wixobj sports.wixobj
