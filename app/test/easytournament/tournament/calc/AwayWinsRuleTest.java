...
public class AwayWinsRuleTest {
  ...
  public void descending() {
    ...
    Rule rule = Rule.ruleMap.get(RuleType.AWAY_WINS_RULE);
    ...
    assertEquals(2, first.getValue(Values.AWAY_WINS).intValue());
    assertEquals(2, second.getValue(Values.AWAY_WINS).intValue());
    assertEquals(1, third.getValue(Values.AWAY_WINS).intValue());
    assertEquals(1, fourth.getValue(Values.AWAY_WINS).intValue());
    assertEquals(1, fifth.getValue(Values.AWAY_WINS).intValue());
    assertEquals(0, sixth.getValue(Values.AWAY_WINS).intValue());
  }
  ...
  public void ascending() {
    ...
    assertEquals(this.teamE, fourth.getTeam());
    assertEquals(this.teamC, fifth.getTeam());
    assertEquals(this.teamF, sixth.getTeam());

    assertEquals(0, first.getValue(Values.AWAY_WINS).intValue());
    assertEquals(1, second.getValue(Values.AWAY_WINS).intValue());
    assertEquals(1, third.getValue(Values.AWAY_WINS).intValue());
    assertEquals(1, fourth.getValue(Values.AWAY_WINS).intValue());
    assertEquals(2, fifth.getValue(Values.AWAY_WINS).intValue());
    assertEquals(2, sixth.getValue(Values.AWAY_WINS).intValue());
  }
