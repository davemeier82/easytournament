...
public class HomeWinsRuleTest {
  ...
  public void descending() {
    ...
    Rule rule = Rule.ruleMap.get(RuleType.HOME_WINS_RULE);
    ...
    assertEquals(3, first.getValue(Values.HOME_WINS).intValue());
    assertEquals(2, second.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, third.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, fourth.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, fifth.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, sixth.getValue(Values.HOME_WINS).intValue());
  }
  ...
  public void ascending() {
    ...
    assertEquals(0, first.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, second.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, third.getValue(Values.HOME_WINS).intValue());
    assertEquals(0, fourth.getValue(Values.HOME_WINS).intValue());
    assertEquals(2, fifth.getValue(Values.HOME_WINS).intValue());
    assertEquals(3, sixth.getValue(Values.HOME_WINS).intValue());
  }
