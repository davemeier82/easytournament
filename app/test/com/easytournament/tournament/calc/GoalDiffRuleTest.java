...
public class GoalDiffRuleTest {
  ...
  public void descending() {
    ...
    Rule rule = Rule.ruleMap.get(RuleType.GOALDIFF_RULE);
    ...
    assertEquals(10, first.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 0, second.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 4, third.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 3, fourth.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 3, fifth.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 5, sixth.getValue(Values.SCORED_HOME_GOALS).intValue());

    assertEquals( 1, first.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 0, second.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 5, third.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 1, fourth.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 5, fifth.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals(13, sixth.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    
    assertEquals( 4, first.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals(10, second.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 1, third.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 3, fourth.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 7, fifth.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 0, sixth.getValue(Values.SCORED_AWAY_GOALS).intValue());

    assertEquals( 1, first.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 9, second.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 0, third.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 6, fourth.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 9, fifth.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 0, sixth.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
  }
  ...
  public void ascending() {
    ...
    assertEquals(this.teamF, fifth.getTeam());
    assertEquals(this.teamC, sixth.getTeam());

    assertEquals( 5, first.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 3, second.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 3, third.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 4, fourth.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals( 0, fifth.getValue(Values.SCORED_HOME_GOALS).intValue());
    assertEquals(10, sixth.getValue(Values.SCORED_HOME_GOALS).intValue());

    assertEquals(13, first.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 5, second.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 1, third.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 5, fourth.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 0, fifth.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    assertEquals( 1, sixth.getValue(Values.RECEIVED_HOME_GOALS).intValue());
    
    assertEquals( 0, first.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 7, second.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 3, third.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 1, fourth.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals(10, fifth.getValue(Values.SCORED_AWAY_GOALS).intValue());
    assertEquals( 4, sixth.getValue(Values.SCORED_AWAY_GOALS).intValue());

    assertEquals( 0, first.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 9, second.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 6, third.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 0, fourth.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 9, fifth.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
    assertEquals( 1, sixth.getValue(Values.RECEIVED_AWAY_GOALS).intValue());
  }
