...
public class HomeDrawsRuleTest {
  ...
  public void setUp() throws Exception {
    ...
    se10.setNumHomeGoals(2);
    se10.setNumAwayGoals(2);
  ...
  public void descending() {
    ...
    Rule rule = Rule.ruleMap.get(RuleType.HOME_DRAWS_RULE);
    ...
    assertEquals(this.teamB, first.getTeam());
    assertEquals(this.teamC, second.getTeam());
    assertEquals(this.teamA, third.getTeam());
    assertEquals(this.teamD, fourth.getTeam());
    assertEquals(this.teamE, fifth.getTeam());
    assertEquals(this.teamF, sixth.getTeam());

    assertEquals(3, first.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(1, second.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, third.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, fourth.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, fifth.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, sixth.getValue(Values.HOME_DRAWS).intValue());
  }
  ...
  public void ascending() {
    ...
    assertEquals(this.teamE, third.getTeam());
    assertEquals(this.teamF, fourth.getTeam());
    assertEquals(this.teamC, fifth.getTeam());
    assertEquals(this.teamB, sixth.getTeam());

    assertEquals(0, first.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, second.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, third.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(0, fourth.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(1, fifth.getValue(Values.HOME_DRAWS).intValue());
    assertEquals(3, sixth.getValue(Values.HOME_DRAWS).intValue());
  }
