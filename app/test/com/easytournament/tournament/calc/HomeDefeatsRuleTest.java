...
public class HomeDefeatsRuleTest {
  ...
  public void descending() {
    ...
    Rule rule = Rule.ruleMap.get(RuleType.HOME_DEFEATS_RULE);
    ...
    assertEquals(this.teamC, fourth.getTeam());
    assertEquals(this.teamD, fifth.getTeam());
    assertEquals(this.teamF, sixth.getTeam());

    assertEquals(5, first.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(1, second.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(1, third.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(0, fourth.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(0, fifth.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(0, sixth.getValue(Values.HOME_DEFEATS).intValue());
  }
  ...
  public void ascending() {
    ...
    assertEquals(0, first.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(0, second.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(0, third.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(1, fourth.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(1, fifth.getValue(Values.HOME_DEFEATS).intValue());
    assertEquals(5, sixth.getValue(Values.HOME_DEFEATS).intValue());
  }
