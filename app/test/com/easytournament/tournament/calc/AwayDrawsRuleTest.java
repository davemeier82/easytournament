...
public class AwayDrawsRuleTest {
  ...
  public void descending() {
    ...
    Rule rule = Rule.ruleMap.get(RuleType.AWAY_DRAWS_RULE);
    ...
    assertEquals(this.teamD, first.getTeam());
    ...
    assertEquals(1, first.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(1, second.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(1, third.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(0, fourth.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(0, fifth.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(0, sixth.getValue(Values.AWAY_DRAWS).intValue());
  }
  ...
  public void ascending() {
    ...
    assertEquals(0, first.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(0, second.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(0, third.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(1, fourth.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(1, fifth.getValue(Values.AWAY_DRAWS).intValue());
    assertEquals(1, sixth.getValue(Values.AWAY_DRAWS).intValue());
  }
