package easytournament.basic.gui.tablecelleditor;
...
public class DateCellEditor extends AbstractCellEditor implements
  ...
  public DateCellEditor(final JDateChooser dateChooser) {
    ...
    this.delegate = new EditorDelegate() {
      ...
      /* (non-Javadoc)
       * @see easytournament.basic.gui.tablecelleditor.DateCellEditor.EditorDelegate#setValue(java.lang.Object)
       */
      @Override
      ...
      /* (non-Javadoc)
       * @see easytournament.basic.gui.tablecelleditor.DateCellEditor.EditorDelegate#getCellEditorValue()
       */
      @Override
