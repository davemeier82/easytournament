...
import com.easytournament.basic.xml.RulesXMLHandler;
...
public class DesignerXMLHandler {
  ...
  private static void save(Element xml, boolean export) {
    ...
    com.easytournament.basic.valueholder.Tournament tourn = Organizer
  ...
  public static void open(Element xml, boolean importing) {
    ...
    com.easytournament.basic.valueholder.Tournament t = Organizer.getInstance()
