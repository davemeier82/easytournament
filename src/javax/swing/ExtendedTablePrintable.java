 ...
 */
public class ExtendedTablePrintable implements Printable {
     ...
     */
    public ExtendedTablePrintable(JTable table,
        ...
        totalHeight = (int) table.getPreferredSize().getHeight();
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
        ...
        double sf = 1.0D;
        if (printMode == JTable.PrintMode.FIT_WIDTH && ( totalHeight > imgHeight ||
            ...
            sf = Math.min((double)imgWidth / (double)totalColWidth, (double) imgHeight / (double) totalHeight);
        }
        ...
        if (sf != 1.0D) {
            g2d.scale(sf, sf);
            int diff = (scaledWidth - clip.width) / 2;
